...
- `README.md`: new "Why this kit exists" section explaining the framework's origin and motivation, plus documentation of the confirmation gate in the "How it works" flow and the agent roster table.
